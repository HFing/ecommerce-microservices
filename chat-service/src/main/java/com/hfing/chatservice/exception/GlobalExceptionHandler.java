...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAllExceptions(Exception ex, WebRequest request) {
        ...
        com.hfing.chatservice.exception.ErrorCode errorCode = ErrorCode.INTERNAL_ERROR;
    ...
    public ResponseEntity<ErrorResponse> handlerUserServiceException(ChatServiceException exception, WebRequest request) {
        ErrorResponse response = ErrorResponse.builder()
